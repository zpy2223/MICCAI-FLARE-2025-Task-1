...
class nnUNetDataLoader(DataLoader):
    ...
    def generate_train_batch(self):
        ...
        # if not self.current_p+self.batch_size < self.indices_len:
        #     self.current_p = 0
        # selected_keys = self.indices[self.current_p:self.current_p + self.batch_size]
        # self.current_p = self.current_p + self.batch_size
